...
public class controllerUploadDiscussionComment extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		if((accessToken != null) && token.get(accessToken)) {
			...
			try
			{	 	
				beanUploadDiscussionComment bean=new beanUploadDiscussionComment();
				bean.setAppId(appId);
				bean.setName(name);
				bean.setEmail(email);
				...
				daoUploadDiscussionComment dao = new daoUploadDiscussionComment();
