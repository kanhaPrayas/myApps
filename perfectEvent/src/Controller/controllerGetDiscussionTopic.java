 ...
 */
public class controllerGetDiscussionTopic extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		if(data.size() != 0) {
			...
			try
			{	 	
				beanGetDiscussionTopic bean=new beanGetDiscussionTopic();   

				bean.setAppId(appId);
				daoGetDiscussionTopic dao = new daoGetDiscussionTopic();
