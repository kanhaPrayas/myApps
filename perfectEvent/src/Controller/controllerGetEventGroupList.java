 ...
 */
public class controllerGetEventGroupList extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		if(data.size() != 0) {
			...
			try
			{	 	
				beanGetEventGroupList bean=new beanGetEventGroupList();   

				bean.setAppId(appId);
				daoGetEventGroupList dao = new daoGetEventGroupList();
